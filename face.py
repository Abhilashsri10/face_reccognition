...
'''
face_name={str1:'.jpg',str2:'.jpg',str3:'.jpg',str4:'.jpg'}
def get_im(strx):
# load an image from file
    imarr_i = load_img(strx, target_size=(224, 224))
# convert the image pixels to a numpy array
    imarr_i = img_to_array(imarr1)
...
face_id={str1:imarr1,str2:imarr2,str3:imarr3,str4:imarr4}
